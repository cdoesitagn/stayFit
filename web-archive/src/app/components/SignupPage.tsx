...
import { Mail, Lock, Eye, EyeOff, User, Apple } from 'lucide-react';
...
export function SignupPage({ onSignupSuccess, onSwitchToLogin }: SignupPageProps) {
  ...
  const handleSocialLogin = (provider: string) => {
    toast.success(`Đang đăng ký với ${provider}...`);
    setTimeout(() => {
      localStorage.setItem('isLoggedIn', 'true');
      onSignupSuccess();
    }, 1000);
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-pink-100">Bắt đầu hành trình của bạn</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                />
                <button
                  type="button"
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-sm text-gray-500">Hoặc đăng ký với</span>
            <div className="flex-1 h-px bg-gray-300"></div>
          </div>
